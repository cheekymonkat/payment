...
public class GetRestController {
    ...
    public GetRestController(final String hostUrl, final PersistanceManager paymentService, final IdGenerator idGenerator) {
    ...
    @Path("/{id}")
    @Timed
    public Response getPayment(@PathParam("id") @NotNull final String id) {
        ...
        try {
            ...
            return Response.status(Response.Status.NOT_FOUND)
                    .entity(new PaymentError("Payment not found"))
                    .build();
